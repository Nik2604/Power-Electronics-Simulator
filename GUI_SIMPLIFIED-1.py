...
contypes = tk.LabelFrame(win, text='Select One in each group, Simulate and Plot(full)',fg = "brown",font = "Verdana 8 bold")
...
tconvt = tk.Label(contypes,text="Type of Converter",font = "Verdana 10 bold",fg = "green").grid(column=0, row=1, sticky=tk.W)

convtype = tk.IntVar()

rad1 = tk.Radiobutton(contypes,text='Half Wave Controlled Rectifier', value=1, variable=convtype,font = "Verdana 10 bold",fg = "blue",)

rad2 = tk.Radiobutton(contypes,text='Full Wave Controlled Rectifier', value=2, variable=convtype,font = "Verdana 10 bold",fg = "blue")

rad3 = tk.Radiobutton(contypes,text='Pulse Width Modulation Inverter', value=3, variable=convtype,font = "Verdana 10 bold",fg = "blue")

rad4 = tk.Radiobutton(contypes,text='AC Voltage Regulator', value=4, variable=convtype,font = "Verdana 10 bold",fg = "blue")
...
nphases = tk.Label(contypes,text="Number of Phases",font = "Verdana 10 bold",fg = "green").grid(column=0, row=7, sticky=tk.W)
...
ilvplt = tk.Radiobutton(plttype,text='Input and Load Voltage', value=4, variable=oneplt,font = "Verdana 10 bold",fg = "blue",)
...
tk.Checkbutton(plttype, text="Input Voltage", variable=ivc,font = "Verdana 10 bold",fg = "blue",).grid(column=0, row=6, sticky=tk.W)
tk.Checkbutton(plttype, text="Load Voltage", variable=lvc,font = "Verdana 10 bold",fg = "blue",).grid(column=0, row=7, sticky=tk.W)
tk.Checkbutton(plttype, text="Load Current", variable=lcc,font = "Verdana 10 bold",fg = "blue",).grid(column=0, row=8, sticky=tk.W)
tk.Checkbutton(plttype, text="Angle(WT)", variable=ac,font = "Verdana 10 bold",fg = "blue",).grid(column=0, row=9, sticky=tk.W)
tk.Checkbutton(plttype, text="Reference Waves", variable=rv,font = "Verdana 10 bold",fg = "blue",).grid(column=0, row=10, sticky=tk.W)
tk.Checkbutton(plttype, text="Carrier Waves", variable=cv,font = "Verdana 10 bold",fg = "blue",).grid(column=0, row=11, sticky=tk.W)
...
load1 = tk.Radiobutton(contypes,text='R Load',  value=1, variable=loadchoice,font = "Verdana 10 bold",fg = "blue",command=sel)

load2 = tk.Radiobutton(contypes,text='RL Load',  value=2, variable=loadchoice,font = "Verdana 10 bold",fg = "blue",command=sel)
...
def simulate():
    ...
    if s==1 and pch==1:
        ...
        if l==1:
            ...
            lvav = (((cos(ad)-cos(beta)))/(2*math.pi))*(V*sqrt(2))
            lcav = lvav/R
            rmsv = math.sqrt(((beta-ad)-(((math.sin(2*beta))-(math.sin(2*ad)))/2))*(V*sqrt(2)*V*sqrt(2)/(4*math.pi)))
        ...
        if l==1:
            ...
            lcav = lvav/R
            rmsv = math.sqrt(((beta-ad)-(((math.sin(2*beta))-(math.sin(2*ad)))/2))*(V*sqrt(2)*V*sqrt(2)/(2*math.pi)))
            rmsc = rmsv/math.sqrt((R*R)+(2*math.pi*f1*2*math.pi*f1*L*L))
            lpowv = (rmsc*rmsc)*R
        i=0
        while i < g:
